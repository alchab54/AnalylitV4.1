...
def test_file_upload_path_traversal_is_prevented(client, setup_project):
    ...
    with patch('api.projects.secure_filename', return_value="etc_passwd") as mock_secure_filename:
        ...
        mock_secure_filename.assert_called_once() # ✅ Vérifie simplement l'appel
