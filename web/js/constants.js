...
export const MESSAGES = {
    ...
    // Core
    taskCancelRequestSent: "Demande d'annulation de la tâche envoyée.",
    taskCancelError: "Erreur lors de l'annulation",
    taskRetrySuccess: (id) => `Tâche ${id} relancée.`, 
    ...
    refreshingAnalyses: 'Rafraîchissement de la section analyses...', 
    searchComplete: (count) => `Recherche terminée: ${count} articles trouvés.`, 
    refreshingResults: 'Rafraîchissement de la section résultats...', 
    ...
    queryRequired: 'Veuillez saisir une requête de recherche.',
    searching: 'Recherche en cours...', 
    searchStarted: 'Recherche lancée en arrière-plan. Les résultats apparaîtront progressivement.',
    selectProjectToSearch: 'Veuillez sélectionner un projet pour lancer une recherche.',
    ...
    noArticlesToScreen: 'Aucun article à screener. Lancez un traitement par lot.',
    // Reporting
    selectProjectForReporting: 'Veuillez sélectionner un projet pour accéder aux rapports.',
    generatingBibliography: 'Génération de la bibliographie...', 
    bibliographyNotImplemented: 'Génération de la bibliographie non implémentée.',
    errorGeneratingBibliography: 'Erreur lors de la génération de la bibliographie.',
    generatingSummaryTable: 'Génération du tableau de synthèse...', 
    summaryTableNotImplemented: 'Génération du tableau de synthèse non implémentée.',
    errorGeneratingSummaryTable: 'Erreur lors de la génération du tableau de synthèse.',
    exportingExcel: 'Exportation du tableau en Excel...', 
    exportExcelNotImplemented: 'Exportation du tableau non implémentée.',
    errorExportingExcel: 'Erreur lors de l\'exportation du tableau en Excel.',
    loadingPrisma: 'Chargement de la checklist PRISMA-ScR...', 
    prismaLoaded: 'Checklist PRISMA-ScR chargée.',
    ...
    prismaChecklistSaved: 'Checklist PRISMA-ScR sauvegardée avec succès.',
    errorSavingPrismaChecklist: 'Erreur lors de la sauvegarde de la checklist PRISMA-ScR.',
    generatingPrismaDiagram: 'Génération du diagramme PRISMA...', 
    prismaDiagramStarted: 'Génération du diagramme PRISMA lancée en arrière-plan.',
    errorGeneratingPrismaDiagram: 'Erreur lors de la génération du diagramme PRISMA',
    // Import
    ...
    referencesImported: (count) => `${count} références importées.`, 
    errorImportingZotero: 'Erreur lors de l\'import Zotero',
    pmidFieldNotFound: "Erreur : le champ d'import de PMID n'a pas été trouvé.",
    ...
    max20Pdfs: 'Maximum 20 PDFs autorisés par upload.',
    uploadingPdfs: (count) => `Upload de ${count} PDF(s)...`, 
    pdfsUploaded: (count) => `${count} PDFs uploadés`, 
    ...
    editButton: 'Éditer',
    runRobAnalysisButton: 'Lancer l\'analyse RoB sur la sélection',
    noRobAssessment: 'Aucune évaluation de biais pour cet article. Lancez l\'analyse.',
    errorPrefix: 'Erreur:',
    robDomainRandomization: 'Randomisation:',
    robDomainMissingData: 'Données manquantes:',
    robDomainOverall: 'Évaluation globale:',
    ...
    robAssessmentSaved: 'Évaluation RoB sauvegardée.',
    selectAtLeastOneArticleForRob: "Veuillez sélectionner au moins un article pour l\'analyse RoB.",
    ...
    noProjectSelectedChat: 'Aucun projet sélectionné',
    selectProjectForChat: 'Sélectionnez un projet pour accéder au chat RAG.',
    chatError: 'Erreur',
    errorLoadingChat: 'Erreur lors du chargement du chat.',
    chatPlaceholder: 'Posez votre question sur les PDFs indexés...', 
    sendButton: 'Envoyer',
    ...
    pdfIndexingStarted: 'Indexation des PDFs lancée en arrière-plan.',
