    ...
    elements.analysisContainer.innerHTML = `
        <div class="card">
            ...
            <div class="card__body">
                ...
                ${plotPath ? `<img src="${plotPath}" alt="Graphique d'analyse" style="max-width:100%;height:auto;margin-top:16px;">` : ''}
            </div>
        </div>
    `;
...
export function showRunAnalysisModal() {
    const content = `
        <div class="analysis-options">
            ...
            <div class="analysis-option" onclick="runProjectAnalysis('meta_analysis')">
                <div class="analysis-icon">📊</div>
                <div class="analysis-details">
             ...
             <div class="analysis-option" onclick="runProjectAnalysis('descriptive_stats')">
                <div class="analysis-icon">📈</div>
                <div class="analysis-details">
