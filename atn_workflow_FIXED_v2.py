...
Date: 08 octobre 2025 16:13 - Fix final avec timestamp dynamique
...
CONFIG = {
    ...
    "max_articles": 350,           # Dataset thèse complet
...
class ATNWorkflowFixed:
    ...
    def __init__(self):
        ...
        self.articles = []
        # ✅ CORRECTION: Timestamp dynamique réel
        self.start_time = datetime.now()

        # Log du démarrage avec timestamp précis
