# Fichier : utils/app_globals.py (VERSION FINALE CORRIGÉE)
...
# Configuration répertoire projects
...
# Créer le répertoire au démarrage si nécessaire (APRÈS la définition)
